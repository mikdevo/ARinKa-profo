window.PROFILE_CONFIG = {
  ...
  roles: {
    ...
    "White Hat": '<i class="fas fa-user-shield"></i>',
    "Offensive Security": '<i class="fas fa-user-secret"></i>',
  },
  dynamic: {
    discord: {
      enabled: true,
      userId: "749678837041725541",
  ...
  socials: [
    { name: "Discord", url: "https://discord.com/users/749678837041725541", icon: "discord" },
